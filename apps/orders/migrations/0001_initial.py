    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('edit', 'Being edited.'), ('submitted', 'Submitted and awaiting processing.'), ('preparation', 'Currently being prepared.'), ('delivery', 'Currently being delivered.'), ('closed', 'Delivered and paid.')], default='edit', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_portion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='menu.foodportion')),
